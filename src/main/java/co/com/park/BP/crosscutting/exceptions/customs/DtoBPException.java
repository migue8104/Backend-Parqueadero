...
public final class DtoBPException extends BPException{
	
	private static final long serialVersionUID = 2325104002394078932L;

	public DtoBPException(final String mensajeUsuario) {
		super(mensajeUsuario, Lugar.DTO);
	}
	
	public DtoBPException(final String mensajeTecnico, final String mensajeUsuario) {
		super(mensajeTecnico, mensajeUsuario, Lugar.DTO);
	}
	
	public DtoBPException(final String mensajeTecnico, final String mensajeUsuario, final Throwable exeptionRaiz) {
